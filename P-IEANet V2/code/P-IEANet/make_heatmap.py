...
img_path = "/home/lzb/CJJ/llama-stack/P-IEANet/heat_map_input"
output_path = "/home/lzb/CJJ/llama-stack/P-IEANet/heat_map_output"
...
for img in tqdm(img_list):
    ...
    exposure = exposure*-1
    tensor_to_heatmap(exposure.detach().cpu(), os.path.join(output_path, img[:-4]+"_exposure.png"))